        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signing up successfully!');
...
exports.reset = exports.logout = exports.login = void 0;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'password sent successfullt');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_vlfhKx7UqgqLGE9T2eZ7KTCm00n0S1Ld1J');
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  e.preventDefault(); //id = #name in signup.pug
